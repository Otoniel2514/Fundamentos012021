...
int main()
{
        ...
        switch(opcion)
    {
        ...
        cout << "Su saldo a descontar del 10% de la Renta es: $" <<DesRenta<< endl;
        break;
        ...
        cout << "Ingrese la cantidad de su sueldo: "<<endl;
        cin >>sueldo2;
        DesAFP =(sueldo2 * 0.01 * 6.25);
        cout<<fixed<<setprecision(2);
        cout << "Su saldo a descontar del 6.25% de AFP es: $" <<DesAFP<< endl;
        break;
        ...
        DesISSS =(sueldo3 * 0.2);
        cout<<fixed<<setprecision(2);
        cout << "Su saldo a descontar del 2% de ISSS es: $"<<DesISSS<< endl;
        break;
    }
    return 0;
}
